        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div class="flex items-start justify-between mb-6">
                ...
                <div class="flex gap-2">
                    ...
                    @if(auth()->user()->id !== $employee->id)
                            <a href="{{ url('/messaging/' . $employee->id) }}"
                                class="px-3 py-1.5 bg-blue-50 text-blue-700 border border-blue-200 text-sm rounded-lg hover:bg-blue-100 flex items-center gap-1.5">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0
